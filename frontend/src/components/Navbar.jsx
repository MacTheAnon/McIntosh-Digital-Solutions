    ...
    <>
      <nav className="fixed w-full z-50 top-0 left-0 border-b border-white/5 bg-[#020617]/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
          ...
          >
            <img src="/mcintosh-logo.png" alt="McIntosh Logo" className="h-10 w-auto object-contain" />
          ...
          >
            {navLinks.map((link, i) => (
              <motion.a
                ...
                className="text-2xl font-['Playfair_Display'] font-bold text-white tracking-wider hover:text-blue-500 transition-colors uppercase"
              >
                {link.name}
              </motion.a>
            ))}
